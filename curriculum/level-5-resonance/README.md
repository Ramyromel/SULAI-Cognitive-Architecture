...
This level formalizes **Coherence-Based Decision** as a cognitive function.
...
- Maintain Observer continuity under Coherence-Based Decision load
...
- `00-intro.md` — Conceptual framing of Coherence-Based Decision
