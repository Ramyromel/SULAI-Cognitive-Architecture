...
This level formalizes **Reality Interpretation Layers** as a cognitive function.
...
- Maintain Observer continuity under Reality Interpretation Layers load
...
- `00-intro.md` — Conceptual framing of Reality Interpretation Layers
