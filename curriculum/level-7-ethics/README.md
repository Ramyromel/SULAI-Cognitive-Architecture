...
This level formalizes **Time-Aware Moral Reasoning** as a cognitive function.
...
- Maintain Observer continuity under Time-Aware Moral Reasoning load
...
- `00-intro.md` — Conceptual framing of Time-Aware Moral Reasoning
